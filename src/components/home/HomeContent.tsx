    ...
    <div className="flex min-h-full flex-col bg-[#f7f8fa] text-[#1f2328]">
      <main className="flex w-full flex-1 flex-col gap-8 px-12 pb-16 pt-8">
        <header className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h1 className="pb-1 text-[1.78rem] font-[680] leading-tight text-[#1f2328]">Home</h1>
            <button className="mt-4 text-[15.5px] inline-flex items-center gap-2 rounded-full border border-transparent px-0 py-1 text-sm text-[#6a7385] transition hover:text-[#1f2328]">
